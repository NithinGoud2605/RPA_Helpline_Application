...
export const ClientProfile = memo(({ profile, specializedProfile }) => {
  ...
  return (
    <>
      ...
      {/* Projects Posted */}
      {specializedProfile?.projects_posted !== undefined && (
        <Card className="tech-panel border-border bg-card/50">
          <CardHeader className="pb-3">
          ...
          <CardContent>
            <div className="p-3 rounded-lg bg-muted/30">
              <span className="text-2xl font-display font-bold text-foreground">
                {specializedProfile.projects_posted || 0}
              </span>
              <p className="text-xs text-muted-foreground mt-1">Total projects posted</p>
            </div>
          </CardContent>
        </Card>
      )}
      ...
      {specializedProfile?.past_projects_summary && (
        <Card className="tech-panel border-border bg-card/50">
          <CardHeader className="pb-3">
            <CardTitle className="text-lg font-display flex items-center gap-2">
              <Briefcase className="w-4 h-4 text-primary" />
          ...
          <CardContent>
            <p className="text-muted-foreground whitespace-pre-wrap">{specializedProfile.past_projects_summary}</p>
          </CardContent>
        </Card>
      )}
